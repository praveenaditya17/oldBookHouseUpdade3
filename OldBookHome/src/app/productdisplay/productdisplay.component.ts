...
export class ProductdisplayComponent implements OnInit {
  ...
  notscrolly = true;
  cartDisplay=false;
  constructor(private router:Router,private loginService:BookSellSearchService,private dialog:MatDialog,private javaService:JavaServiceService,public spinner:NgxSpinnerService) { }
