...
public class OldBookSellController {
		...
		public void updateBookStatus(@RequestBody SellOrderRequestDTO sellOrderRequestDTO) {
			...
			if(sellOrderRequestDTO.getCheck_status().equals("PickUpOrder")) {//Sucess
		...
		public Book updateBookPrice(@RequestBody int array[]){
			return bookService.updateBookPrice(array[0],array[1]);
		}
		...
		public Payment savePayment(@RequestBody PaymentDTO payment) {
			...
			buyOrderRequestDTO.setCheckStatus("PendingOrder");//pending
		...
		public Iterable<Object> getInvoice(@RequestBody String transatctionId) {
			System.out.println(transatctionId);
